...
function actionPage(){
    ...
    min.addEventListener('input', ()=>{
        let minRenge = document.querySelector('#renge-min-counter');

        minRenge.textContent = min.value;
    });

    max.addEventListener('input', ()=>{
        let maxRenge = document.querySelector('#renge-max-counter');

        maxRenge.textContent = max.value;
    });
